...
export default function SideBar() {
	return (
		<>
			...
			<div className="fixed top-0 left-0 m-0 hidden h-screen w-[12rem] flex-col bg-white p-2 pt-[8rem] text-primary shadow-xl transition-all duration-100 ease-in-out hover:flex peer-hover:flex">
